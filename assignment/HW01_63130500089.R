...
#Create data structure in variable named marvel_movies 
marvel_movies <- list(names,years)

#explain why you using this data structure? เพราะว่า List สามารถรวบรวมได้หลากหลายชื่อได้โดยที่ไม่ต้องเกี่ยวข้องกันและเหมาะที่จะเก็บในรูปแบบ ชื่อเพลง, ชื่อหนัง ต่างๆ 
