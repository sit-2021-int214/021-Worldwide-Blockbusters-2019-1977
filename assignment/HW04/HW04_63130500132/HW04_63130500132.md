...
```
Explain
- ใช้ `group_by()` เพื่อจัดกลุ่มข้อมูลหนังสือแต่ละประเภท
- ใช้ `select()` เพื่อเลือกข้อมูลที่ต้องการ
- ใช้ `summarise()` เพื่อหาผลลัพธ์ของค่าเฉลี่ยหรือmean
...
[PowerIB](https://app.powerbi.com/view?r=eyJrIjoiNjc2MjFmM2ItYTE0NC00ODNhLThiZmEtYjdhNjI5M2Y5OTdkIiwidCI6IjZmNDQzMmRjLTIwZDItNDQxZC1iMWRiLWFjMzM4MGJhNjMzZCIsImMiOjEwfQ%3D%3D)
